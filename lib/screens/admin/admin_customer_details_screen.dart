...
class _AdminCustomerDetailsScreenState
    ...
    if (status.isDenied) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
              'Storage permission is permanently denied. Please enable it from the app settings.'),
          actions: [
            TextButton(
  ...
  void _showCustomerDetailsDialog(
    ...
    final int returnQuantity = data['returnedQuantity'] as int? ?? 0;
    final double returnAmount = data['returnedAmount'] as double? ?? 0;
